...
const dictionary_controller_1 = require("./constroller/dictionary.controller");
...
exports.DictionaryModule = DictionaryModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [dictionary_service_1.DictionaryService, dictionary_repository_1.DictionaryRepository, prisma_service_1.PrismaService],
    })
], DictionaryModule);
